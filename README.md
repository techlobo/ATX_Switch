...
## Control ATX capability of multiple systems from DIY PiKVM host
...
Supports the control of multiple ATX-enabled endpoint devices, in conjunction with a KVM switch, from a single DIY PiKVM unit.
...
![](./Images/Typical_deployment_architecture_v1.png)
...
This is a synopsis of my adventures in this area while setting up management on my home lab environment. It works for me, but there are no guarantees it will for you. I've documented this for my own benefit, including getting some idea of how Github and Markdown works. If you want to try something similar then please feel free to use any (*or none*) of the above material - at your own risk...!
